...
[.small]
Author: Giovanni Vergine, verginegiovanni@gmail.com
[.small]
Date: {doc_date}
...
`qnx-buildfile-lang` is a set of java-based tooling implemented using link:https://eclipse.dev/Xtext/[Xtext] for parsing link:https://www.qnx.com/developers/docs/8.0/com.qnx.doc.neutrino.building/topic/buildfiles/buildfile.html[QNX Buildfiles] 
...
* If you are familiar with the Xtext grammar notation, you can see understand the AST simply link:https://github.com/gvergine/qnx-buildfile-lang/blob/master/qnx.buildfile.lang.parent/qnx.buildfile.lang/src/qnx/buildfile/lang/BuildfileDSL.xtext[looking at it]. 
